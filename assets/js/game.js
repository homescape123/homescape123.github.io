...
let allGames = [];
let visibleGamesCount = 30;

/// Function to configure site data
function configureSiteData() {
    // Define site data variables
    const siteName = 'Homescapes';
    const logoPath = '/assets/images/homescapes.jpg';
    const faviconPath = '/assets/images/homescapes.jpg'; // Added favicon path

    // Update site name in header and footer
    document.getElementById('siteName').textContent = siteName;
    document.getElementById('siteNameFooter').textContent = siteName;
...
window.addEventListener('load', () => {
    configureSiteData(); // Call site configuration on page load
    preloadGameURLs();
    loadGameData();
    updateFavoriteButton();
    updateAverageRating();
